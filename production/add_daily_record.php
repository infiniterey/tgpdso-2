...
else
{
    $lastname = "Here";
        ...
        $result=mysqli_query($conn,"select * from production WHERE lastName = '$lastname'");
        ...
        while($row=mysqli_fetch_Array($result))
        {
          ...
          <input type="text" name="firstName" value="<?php echo $row['policyNo'];?>"><br>
          <input type="text" name="firstName" value="<?php echo $row['receiptNo'];?>"><br>
        <?php
      };
  }
