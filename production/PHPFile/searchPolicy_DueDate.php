             ...
             <tr>
               ...
               <td>
                 <div class = "row" align="center">
                     <a id="searchClient" onclick='return searchClientNextDue();' title="Edit Data" href="dueDate.php?edit=<?php echo $row['policyNo'] ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
