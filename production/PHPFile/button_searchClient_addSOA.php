<div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="datatable-fixed-header082" name="datatable-fixed-header082" align="center" class="table table-bordered table-hover no-footer" role="grid" aria-describedby="datatable-fixed-header_info" onclick="showButtons1()">
          <thead>
            <tr role="row">
        ...
        <script>
        var table = document.getElementById('datatable-fixed-header082');
