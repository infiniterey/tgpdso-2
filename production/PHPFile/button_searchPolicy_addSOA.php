<div class="modal-dialog modal-md">
  <div class="modal-content">
    ...
    <table name="datatable-fixed-header03" id="datatable-fixed-header03" class="table table-bordered table-hover no-footer" role="grid" aria-describedby="datatable-fixed-header_info" onclick="closemodal()" >
     <thead>
       <tr role="row">
